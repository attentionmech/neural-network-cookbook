...
# 7. Training loop with validation and tracking overfitting
for epoch in range(epochs):
    ...
    # Track overfitting by comparing training and validation performance
    if val_accuracy < train_accuracy:
        print("Warning: Overfitting detected! Validation performance is worse than training performance.")
